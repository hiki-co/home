          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            ...
            <div className="animate-fade-in-up stagger-1">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="hiki-card-interactive">
                  <h4 className="text-sm text-foreground font-medium">暇してる</h4>
                </div>
                <div className="hiki-card-interactive">
                  <h4 className="text-sm text-foreground font-medium">スキルある</h4>
                </div>
                <div className="hiki-card-interactive">
            ...
            <div className="animate-fade-in-up stagger-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="hiki-card-interactive">
                  <h4 className="text-sm text-foreground font-medium">何か売る</h4>
                </div>
                <div className="hiki-card-interactive">
                  <h4 className="text-sm text-foreground font-medium">話し相手</h4>
                </div>
                <div className="hiki-card-interactive">
